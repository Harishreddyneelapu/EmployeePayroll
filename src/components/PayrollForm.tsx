...
const EmployeePayrollForm: React.FC = () => {
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)} className="max-w-2xl mx-auto px-16 py-4 shadow-xl rounded-md">
            <div className="mb-4">
            ...
            <div className="flex justify-between">
                ...
                <div className="space-x-4">
                    <button type="submit" className="px-4 py-2 bg-gray-300 text-white rounded-md">Submit</button>
